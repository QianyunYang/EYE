...
namespace eye
{
  ...
  public:
    ...
    void SearchWithOptGraph(std::vector<std::string> attributes,
                            ...
                            unsigned *indices);
    void SearchWithOptGraph(std::vector<int> attribute,
                            const float *query, size_t K,
                            const Parameters &parameters,
                            unsigned *indices);
    ...
    void setAbility(const Parameters& parameters);
  ...
  protected:
    ...
    std::vector<std::vector<std::string>> attributes_kindnum;
    int attribute_number_ = 7;
    int ab = 1;
    float alpha = 1.0;
  ...
  private:
    ...
    std::vector<int> Attribute2int(std::vector<std::string> str);
  };
}
